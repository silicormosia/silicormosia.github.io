...
[GriddingMachine.jl](https://github.com/CliMA/GriddingMachine.jl) is a software and database designed to share global scale datasets for Earth system modeling. GriddingMachine is a registered package and currently with a stable version v0.3. It is not recommended to use version v0.1.
