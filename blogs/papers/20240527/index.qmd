...
![Fig. 1 LSMs do not model UV explicitly, thus tend to overestimate UV albedo. LSMs do not account for FR's contribution to photosynthesis, thus tend to underestimate plant productivity.](highlight.png)
