...
- $f_\text{APAR}$: Fraction of PAR absorbed by the leaf ($APAR = PAR \cdot f_\text{APAR}$);
- $f_\text{PPAR}$: Fraction of APAR absorbed by chlorophyll (and some carotenoid; $PPAR = APAR \cdot f_\text{PPAR}$);
