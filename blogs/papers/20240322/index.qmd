...
However, finding a similar steady state for complicated canopy models as in [CliMA Land](https://github.com/CliMA/Land) is overwhelming. For example, any change in gs would lead to changes in A and E, and thus leaf latend heat flux, leaf temperature, longwave radiation, hydraulic profiles, etc.
