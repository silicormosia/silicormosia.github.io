...
image: ../../images/griddingmachine.svg
...
[GriddingMachine.jl](https://github.com/CliMA/GriddingMachine.jl) is a software and database designed to share global scale datasets for Earth system modeling. GriddingMachine is a registered package and currently with a stable version v0.2. It is not recommended to use version v0.1.
...
```
This will constrain the version to exactly v0.2.8. See [https://pkgdocs.julialang.org/v1/compatibility/](https://pkgdocs.julialang.org/v1/compatibility/) for more details about how to best utilize "Project.toml" file to manage the Julia environment.
